...
type Props = {
  ...
  goals?: Goal[]; // If provided, shows goal dropdown
};
        ...
        >
          <Pressable style={styles.modal} onPress={e => e.stopPropagation()}>
            ...
            <TextInput
              ...
              autoFocus
              returnKeyType={showLabelInput || goals ? 'next' : 'done'}
              onSubmitEditing={!showLabelInput && !goals ? handleSubmit : undefined}
            />
            ...
            {showLabelInput && (
              <TextInput
                ...
                returnKeyType={goals ? 'next' : 'done'}
                onSubmitEditing={!goals ? handleSubmit : undefined}
              />
            )}
              ...
              <View style={styles.goalSection}>
                ...
                >
                  <Text
                    style={[
                      ...
                      !selectedGoal && styles.goalPlaceholder,
                    ]}
                  >
                ...
                {showGoalPicker && (
                  <View style={styles.goalList}>
                    ...
                    >
                      <Text style={[styles.goalOptionText, styles.goalPlaceholder]}>
                        No goal
                      </Text>
                    </Pressable>
                    {goals.map(goal => (
